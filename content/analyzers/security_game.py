...
# # Key length.
#
# key = generate_random_keys(length=10, max_index=1)
#
# init_zero = []
# init_one = []
# final_zero = []
...
#     #       f"{content.count('1')}")
#     init_zero.append(content.count('0'))
#     init_one.append(content.count('1'))
...
#     # print("")
#     # print("")
#     final_zero.append(content.count('0'))
#     final_one.append(content.count('1'))
#
#
# print(f"On average the string start with {np.mean(init_zero)} zeros.")
# print(f"On average the string start with {np.mean(init_one)} ones.")
# print(f"On average the string end up with {np.mean(final_zero)} zeros.")
# print(f"On average the string end up with {np.mean(final_one)} ones.")
#
#
